...
public class WishingWallCommand implements ISlashCommand
{
	...
	@Override
	public void slashCommandExecuted(SlashCommandInteractionEvent event1, Guild guild, User author, SlashCommandChannel channel, SlashCommandMessage message)
	{
		...
		SelectMenu.Builder menuBuilder = SelectMenu.create(menuID.toString()).setPlaceholder("Select the wish").setRequiredRange(1, 1);

...
public class TrackScheduler extends PlayerEventListenerAdapter
{
	...
	{
		Startup.discordClient.getEventManager().handle(new StartTrackEvent(Startup.discordClient, track));
	}
	...
	public void onTrackEnd(IPlayer player, AudioTrack track, AudioTrackEndReason endReason)
	{
		if(currentTrack != null) {
			...
			Startup.discordClient.getEventManager().handle(new EndTrackEvent(Startup.discordClient, aTrack, queue.peek()));
		}
		...
		for (TrackObject object : objects) {
			for (TrackObject.Track tr : object.tracks) {
				...
				if (track != null) {
					...
					queue(track);
					Startup.discordClient.getEventManager().handle(new QueueTrackEvent(Startup.discordClient, track));

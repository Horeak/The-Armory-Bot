...
{
	@SlashArgument( key = "channel", text = "The voice channel you want the bot to join", required = true)
	...
	@Override
	public void slashCommandExecuted(SlashCommandInteractionEvent slashEvent, Guild guild, User author, SlashCommandChannel channel12, SlashCommandMessage message)
	{

...
{
	@SlashArgument( key = "count", text = "The amount of songs to go backwards" )
	...
	@Override
	public void slashCommandExecuted(SlashCommandInteractionEvent slashEvent, Guild guild, User author, SlashCommandChannel channelX, SlashCommandMessage message)
	{
